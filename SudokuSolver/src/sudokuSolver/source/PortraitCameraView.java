...
public class PortraitCameraView extends JavaCameraView implements PreviewCallback {
    ...
    synchronized (this) {
        ...
        for (int i = 0; i < numberOfCameras; i++) {
            ...
            if (cameraInfo.facing == android.hardware.Camera.CameraInfo.CAMERA_FACING_BACK) {
                try {
                    ...
                    mCameraId = i;
                    connected = true;
                    Log.i("isaac_debug", "Camera # " + i + "open");
                } catch (RuntimeException e) {
                    Log.e("isaac_debug", "Camera # " + i + "failed to open: " + e.getMessage());
                }
                if (connected) break;
            }
        }
        ...
        try {
            ...
            if (sizes != null) {
                ...
                Log.d("isaac_debug", "Set preview size to " + Integer.valueOf((int)frameSize.width) + "x" + Integer.valueOf((int)frameSize.height));
